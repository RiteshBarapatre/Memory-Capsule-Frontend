...
function GhostWall() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      const updated = ghostService.updateFadeLevels()
      setPosts(updated.filter((p) => new Date(p.expiresAt) > new Date()))
      ...
      <div className="max-w-2xl mx-auto">
          ...
          <div className="flex gap-3">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center justify-between mt-2">
                <span className={cn(
                  'text-xs',
                  newPost.length > 250 ? 'text-destructive' : 'text-muted-foreground'
                )}>
                  {newPost.length}/280
                </span>
                <AnimatedButton
        ...
        >
          <p className="text-sm text-muted-foreground">
            All posts are anonymous and will gradually fade over 24 hours until they disappear completely. 
            No post history is stored.
          </p>
        </motion.div>
